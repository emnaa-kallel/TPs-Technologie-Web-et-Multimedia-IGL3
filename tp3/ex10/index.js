...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var library, userRepo, adminRepo, user1, admin1, books, success;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    library = new Library_1.Library();
                    userRepo = new Repository_1.Repository();
                    adminRepo = new Repository_1.Repository();
                    user1 = new User_1.User(1, 'Emna');
                    admin1 = new Admin_1.Admin(1, 'Mohamed');
                    userRepo.add(user1);
